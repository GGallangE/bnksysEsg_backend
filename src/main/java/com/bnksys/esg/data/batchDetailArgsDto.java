...
public class batchDetailArgsDto {
    private int batchDetailListId;
    ...
    public void setBatchDetailListId(int batchDetailListId) {
        this.batchDetailListId = batchDetailListId;
    }
